...
public class BBinSearchTree extends Applet
   ...
   Image im0,im1,im2,im3,im4,im5,im6,im7,im8,im9,c1,c2,c3,c4,s,alpha,key;
   URL url1,url2,url3,url4,url5,url6,url7,url8,url9,url0,urlc,urlcb,urlcl,urlclb,urls,urlkey;
   int k=0,prev=0,l=0;
   int start=0;
   int choice=0;
   Thread th;
...
x[15]=0;y[15]=0;
      loadImage();
      filterImage();
      tree1=getAudioClip(getDocumentBase(),"tree1.wav");
      tree1.play();
      //t1.stop();  

     // cursor=Cursor.getDefaultCursor();   
      //newcursor=tk.createCustomCursor(key,new Point(1,1),"search key"); 
      //setCursor( newcursor);
      //setCursor(cursor);
   }
...
action.setText( "This is because H occurs after E" );
      tree6=getAudioClip(getDocumentBase(),"tree6.wav");
      tree6.play();
for(int p=0;p<110000;p++)
for(int q=0;q<20000;q++)
{;}
...
class Main extends Frame
{
  ...
  {
   super(frameTitle);
   BBinSearchTree tree=new BBinSearchTree();
